...
if tipo == "alto":
	kernel_ft = fftpack.fft2(highpassfilter(ksize), axes=(0, 1)) # Usando el metodo nativvo de python TT
	#kernel_ft = bifourier(highpassfilter(ksize)) #Usando mi propia implementación.
elif tipo == "bajo":
	kernel_ft = fftpack.fft2(lowpassfilter(ksize), axes=(0, 1)) # Usando el metodo nativvo de python TT
